...
class student
{
    int rollno;
    char name[50];
    int eng_marks, math_marks, sci_marks, frc_marks, hist_marks;
    double average;
    char grade;
...
{
    average = (eng_marks + math_marks + sci_marks + frc_marks + hist_marks) / 5.0;
    if (average >= 90)
        grade = 'A';
    else if (average >= 75)
        grade = 'B';
...
// modificarea unui record dupa numarul de identificare
